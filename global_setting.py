...
PreUbuntu_software = ('build-essential autoconf automake libtool git cvs swig g++ gfortran python-pip libatlas-* libfftw3-* libcfitsio3* liblapack* python-dev csh xorg-dev libx11-dev')

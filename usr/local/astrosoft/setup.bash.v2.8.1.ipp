####### DIFX VERSION ########################
export DIFX_VERSION=DiFX-2.8.1-ipp

####### ROOT PATHS ##########################
export DIFXROOT=/usr/local/astrosoft/difx281-ipp
export DIFX_PREFIX=$DIFXROOT
export PGPLOTDIR=
export IPPROOT=/opt/intel/composer_xe_2015.5.223/

####### COMPILER ############################
export DIFXMPIDIR=/usr/lib64/mpich-3.2
